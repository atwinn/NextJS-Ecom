    ...
    return (
        <>
            ...
            <div className="flex  items-center gap-x-2">
                <div className="flex items-center gap-2 hover:bg-[#06529a] px-3 rounded-full transition-all">
                    <MdLogin className="text-[17px] rotate-90" />
                    <p className="text-[16px] font-semibold pt-4">Register</p>
                </div>
                <div className="flex items-center gap-2 hover:bg-[#06529a] px-3 rounded-full whitespace-nowrap transition-all">
        ...
        <>
            <div className="hidden relative lg:flex items-center flex-1 mx-6 ">
                <div className="flex justify-center items-center w-full">
                    ...
                    <input
                        type="text"
                        className="rounded-none border-0 py-3 flex-1 outline-0 text-black bg-white"
